...
<div class="wrapper">
    <div class="about">
      ...
      <div id='accordion' class='faq'>
        ...
        <h6>Company X says they&apos;ll make the site for $500. Why shouldn&apos;t we hire them instead?</h6>
        <div>
          <p>
            In websites, just like in life, <strong>you get what you pay for</strong>. Real web development and design takes time, effort, and money.
            <br />
            <br />
            A $500 site, will either be done way too quickly (meaning they didn&apos;t take the necessary time to actually create something beautiful) or will be finished months late. In all likelihood, it will be someone slapping your content onto a template on WordPress with no thought about whether it looks good or not. For some people, this is fine, not us though. We want to create something memorable and beautiful for you.
            <br />
            <br />
            That&apos;s all assuming they won&apos;t come back after you&apos;ve signed the contract with a bunch of hidden costs.
            <br />
            <br />
        ...
        <div>
          <p>
            We do! Just have them let us know you referred them and we&apos;ll offer you a discount on your next project!
          </p>
        </div>
        <h6>Do I own the website you create?</h6>
        <div>
          <p>
            Absolutely! Everything we create is 100% yours. However, we do retain the right to re-use any code we create for other sites.
          </p>
        </div>
        <h6 class="altRow">What am I responsible for during the development process?</h6>
        <div>
          <p>
            The biggest thing you are responsible for is being timely with content we request(we will always let you know well in advance when we will need content by). This keeps the project from being held up. If you need a copywriter or a photographer we can connect you to one in our network.
            <br>
            <br>
            If you provide us with an image or some other creative for use on your site, we make the legal assumption that you have the legal rights to use that image. Mount McKinney bears no responsibility if you provide us with an image and it turns out to infringe on a copyright.
            <br>
            <br>
            Lastly, treat us how you would like to be treated.
          </p>
        </div>
        <h6>How long will my site take?</h6>
        <div>
          <p>
            We will provide you a timeline with the quote so you can know before we start when you can expect to have your shiny new site.
            <br>
            <br>
            A site&apos;s timeline can vary greatly due to your specific situation. An average site will take 2-4 weeks but this can be increased due to site complexity and revisions.
          </p>
        </div>
        <h6 class="altRow">Can I see my site while it&apos;s in development?</h6>
        <div>
          <p>
            Of course! We will provide you with a link to see the status of your site while it&apos;s being created. If you see something you don&apos;t like, let us know!
          </p>
        </div>
