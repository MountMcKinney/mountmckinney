  ...
  <div class="mobileMenu">
    ...
    <a href="#" class="mobileMenuToggle menuBtn">Close</a></h3>
      <ul>
        ...
        <a href="#" class="contactPopUp"><li><img src="<?php echo BASE_URL; ?>img/social/mailIcon.svg" alt="Contact Icon"  class="menuIcons" />Contact</li></a>
...
<div class="menu">
  <ul>
    ...
    <a href="#" class="contactPopUp"><li class="menuHover"><img src="<?php echo BASE_URL; ?>img/social/mailIcon.svg" alt="Contact Icon"  class="menuIcons" /><br/>Contact</li></a>
