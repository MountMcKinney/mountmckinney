<?php
  ...
  function displayCampfireBlog($cfstory){
    ...
    $output .= "</div>";
    $output .= '<p class="blogContent">'.$cfstory["p1"].'</p>';
    $output .= '<br />';
    ...
    $output .= '<br />';
    $output .= '<p class="blogContent">'.$cfstory["p6"].'</p>';
    $output .= '<br />';
    $output .= '<p class="blogContent">'.$cfstory["p7"].'</p>';
    $output .= '<br />';
    $output .= '<p class="blogContent">'.$cfstory["p8"].'</p>';
    $output .= '<br />';
    $output .= '<p class="blogContent">'.$cfstory["p9"].'</p>';
    $output .= '<br />';
...
function getAllCfstories() {
  ...
  $cfstories["world-is-your-oyster"] = array(
    ...
    "aside1" => "img/blog/aside/paris.jpg",
    "aside1Alt" => "A Paris Sunset",
    ...
    "aside2" => "img/blog/aside/italianCountrysideAside2.jpg",
    "aside2Alt" => "The Italian Countryside",
  ...
  $cfstories["nc-fall-foliage-stikes-back"] = array(
    ...
    "aside1" => "img/blog/aside/foliageStrikesAside1.jpg",
    "aside1Alt" => "The wife and I hiking up the mountains",
    ...
    "aside2" => "img/blog/aside/foliageStrikesAside2.jpg",
    "aside2Alt" => "The whole group looking over our last vista",
  ...
  $cfstories["nc-fall-foliage"] = array(
    ...
    "aside1" => "img/blog/aside/fallFoliageAside1.jpg",
    "aside1Alt" => "The steep climb up the Chimney Tops",
    ...
    "aside2" => "img/blog/aside/fallFoliageAside2.jpg",
    "aside2Alt" => "The cool waterfall water crashing down on us",
  ...
  $cfstories["nm-sandia"] = array(
    ...
    "aside1" => "img/blog/aside/peakAside1.jpg",
    "aside1Alt" => "The gondola we took all the way to the top",
    ...
    "aside2" => "img/blog/aside/peakAside2.jpg",
    "aside2Alt" => "Me admiring the view from 10,000 feet",
  ...
  $cfstories["nm-bandelier"] = array(
    ...
    "aside1" => "img/blog/aside/bandAside.jpg",
    "aside1Alt" => "The village below the cave dwellings",
    ...
    "aside2" => "img/blog/aside/bandAside2.jpg",
    "aside2Alt" => "Me and my wife, cramped in the cave dwellings",
  ...
  $cfstories["nm-jemez"] = array(
    ...
    "aside1" => "img/blog/aside/jemezAside.jpg",
    "aside1Alt" => "My wife, dangling her legs off a cliff near a waterfall",
    ...
    "aside2" => "img/blog/aside/valles.jpg",
    "aside2Alt" => "The Valles Caldera",
  ...
  $cfstories["nm-home"] = array(
    ...
    "aside1" => "img/blog/aside/homeAside.jpg",
    "aside1Alt" => "Goofy picture on a rock near the house",
    ...
    "aside2" => "img/blog/aside/homeAside2.jpg",
    "aside2Alt" => "My wife flexing like a strong man",
  ...
  $cfstories["nm-kasha-katuwe"] = array(
    ...
    "aside1" => "img/blog/aside/kk.jpg",
    "aside1Alt" => "Hiking through the slot canyon",
    ...
    "aside2" => "img/blog/aside/kkVista.jpg",
    "aside2Alt" => "The view was truly something incredible.",
  ...
  $cfstories["nm-diversity"] = array(
    ...
    "aside1" => "img/blog/aside/jemez.jpg",
    "aside1Alt" => "Red rock beauty",
    ...
    "aside2" => "img/blog/aside/diveAside1.jpg",
    "aside2Alt" => "Me at the edge of a cliff near a waterfall",
  ...
  $cfstories["slideball"] = array(
    ...
    "aside1" => "img/blog/aside/slideballSetup.jpg",
    "aside1Alt" => "Set up of the field prior to the game",
    "p3" => "<dl class='campfireList'>
    ...
    "aside2" => "img/blog/aside/slideballAfter.jpg",
    "aside2Alt" => "After the game is over, we just spent a good 10 mins running around sliding",
  ...
  $cfstories["trad-backpack"] = array(
    ...
    "aside1" => "img/blog/aside/mountainsWeight.jpg",
    "aside1Alt" => "Now I'm prepared no matter what",
    ...
    "aside2" => "img/blog/aside/tradBackOverboard.jpg",
    "aside2Alt" => "Even as the storms roll in, I'm covered",
    "catch" => "Remember, Adventure is Calling!",
    "signature" => "John McKinney",
    "date" => "June 16th, 2015 "
  );
  $cfstories["sawyer-mini"] = array(
    ...
    "aside1" => "img/blog/aside/sawyerDirty.jpg",
    "aside1Alt" => "When in the backcountry, clean water is essential",
    ...
    "aside2" => "img/blog/aside/sawyerMini.jpg",
    "aside2Alt" => "Cleaning dirty water will keep you alive",
    "catch" => "Remember, Adventure is Calling!",
    "signature" => "John McKinney",
    "date" => "June 4th, 2015 "
  );
  $cfstories["cohutta-mountain"] = array(
    ...
    "aside1" => "img/blog/aside/cohuttaTent.jpg",
    "aside1Alt" => "Our tent near the river",
    ...
    "aside2" => "img/blog/aside/cohuttaMe.jpg",
    "aside2Alt" => "Me being goofy down by the falls",
  ...
  $cfstories["juniper-springs"] = array(
    ...
    "aside1" => "img/blog/aside/juniperTent.jpg",
    "aside1Alt" => "Our 6 persion mansion",
    ...
    "aside2" => "img/blog/aside/juniperTurtle.jpg",
    "aside2Alt" => "Turtles sunbathing",
  ...
  $cfstories["fixed-blade"] = array(
    ...
    "aside1" => "img/blog/aside/knifeRambo.jpg",
    "aside1Alt" => "Rambo's ridiculously large knife",
    "p3" => "<dl class='campfireList'>
                <dt>Full-tang:</dt>
    ...
    "aside2" => "img/blog/aside/blades.jpg",
    "aside2Alt" => "Some of your choices",
  ...
  $cfstories["grayton-beach"] = array(
    ...
    "aside1" => "img/blog/aside/graytonSunset.jpg",
    "aside1Alt" => "Sunsets on the beach",
    ...
    "aside2" => "img/blog/aside/graytonWater.jpg",
    "aside2Alt" => "Serene water during the bike ride",
  ...
  $cfstories["3-day-spring-pack"] = array(
    ...
    "aside1" => "img/blog/aside/tradBackOverboard.jpg",
    "aside1Alt" => "Contents of my bag, laid out",
    ...
    "aside2" => "img/blog/aside/threeDaySpring.jpg",
    "aside2Alt" => "Now I'm prepared no matter what",
    "catch" => "Remember, Adventure is Calling!",
    "signature" => "John McKinney",
  ...
  $cfstories["clearwater-lake"] = array(
    ...
    "aside1" => "img/blog/aside/clearwaterOcalaTent.jpg",
    "aside1Alt" => "Campground, my tent",
    ...
    "aside2" => "img/blog/aside/clearwaterOcalaOdd.jpg",
    "aside2Alt" => "The best party people ever",
