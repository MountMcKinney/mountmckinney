...
<div id="wrapper-contact">
  <div class="about">
    ...
    <p>Hi, my name is John McKinney. I am a freelance web developer and outdoor enthusiast. If you'd like to read about my trips to some of the most beautiful natural landmarks our country has to offer, head over to <a href="<?php echo BASE_URL;?>campfirestories/">Campfire Stories</a>.</p>
    <p>As for the tips I&#39ll be giving you, I am by no means an expert. I just spend a large amount of my time researching camping gear. If I am going to spend my hard earned money and use something in the backcountry I need to know it's going to work. You can think of my articles as a summary of expert opinions.</p>
    <p>If you'd like more info on the web development services I offer as well as check out my portfolio of work, head to the <a href="<?php echo BASE_URL;?>portfolio/">Portfolio</a> tab. If you need any further info or just want to chat with me, I can be reached via the contact links on this page.</p>
